...
module.exports = function SaveHomePageSettingsModule(pb) {
    ...
    /**
     *  Saves settings for the display of home page content in the Probo theme
        ...
        this.getJSONPostParams(function(err, post) {
            ...
            dao.q('probo_theme_settings', opts, function(err, homePageSettings) {
                ...
                if(homePageSettings.length > 0) {
                    ...
                    homePageSettings = pb.DocumentCreator.create('probo_theme_settings', post);
    ...
    SaveHomePageSettings.getRoutes = function(cb) {
        var routes = [
            {
                method: 'post',
                path: '/actions/admin/plugins/settings/probo/home_page',
                auth_required: true,
